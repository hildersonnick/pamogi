    ...
    if (props.progress === 'initialized' || props.progress === undefined) {
        ...
        return (
            <group {...props} dispose={null}>
                <group position={[23.34, 0, -22.01]} rotation={[-Math.PI + props.rotate, 0, -Math.PI]} scale={[0.81, 0.79, 0.96]}>
...
useGLTF.preload(process.env.PUBLIC_URL + '/newermodels/task135.glb');
