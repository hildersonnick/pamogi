    ...
    if (props.progress === 'initialized' || props.progress === undefined) {
        ...
        return (
            <group {...props} dispose={null}>
                <group position={[2.62, 0, -14.79]} rotation={[-Math.PI + props.rotate, 0, -Math.PI]} scale={[-0.81, 0.79, 0.96]}>
...
useGLTF.preload(process.env.PUBLIC_URL + '/newermodels/task125.glb');
