...
export default function Model(props) {
  ...
  if (props.progress === "complete") {
    const { nodes, materials } = useGLTF("/newerModels/complete.glb");
    return (
      <group {...props} dispose={null}>
        <group
          position={[15.59, 0, -38.43]}
  ...
  if (props.progress === "progress") {
    const { nodes, materials } = useGLTF("/newerModels/progress.glb");
...
useGLTF.preload("/newerModels/task154.glb");
useGLTF.preload("/newerModels/progress.glb");
useGLTF.preload("/newerModels/complete.glb");
